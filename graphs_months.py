...
def bar_graph_stacked_km_div(person_id):
    df = kilometers_data(person_id)
    rows = len(df.index)
...
# with open('div.txt', 'w', encoding='utf-8') as txt:  # open in context so you dont need to call close()
#     txt.write(fig_plot)  # here I am using library csv
